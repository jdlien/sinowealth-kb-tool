...
public class DeviceFile_NRF52820_8K : DeviceFile
{
	public DeviceFile_NRF52820_8K(string _icName, string fileNameWithoutExtension, byte[] sourceFile)
	...
	{
		return new string[3] { "nrf52820_8k", "nrf52820-8k", "nrf52820-gmmax-8k" };
	}
	...
	public override void SetFileType(CXFILE_TYPE fileType)
	{
		...
		case CXFILE_TYPE.Mouse:
			...
			bootEndPoints.Add(new string[2] { "vid_3554&pid_f517&mi_01&col07", "vid_3554&pid_f517&mi_01&col07" });
