...
public class DeviceFile_CX52650P : DeviceFile
{
	public DeviceFile_CX52650P(string _icName, string fileNameWithoutExtension, byte[] sourceFile)
	...
	public override void SetFileType(CXFILE_TYPE fileType)
	{
		...
		case CXFILE_TYPE.Keyboard:
			...
			bootEndPoints.Add(new string[2] { "vid_3554&pid_f405&mi_01&col01", "vid_3554&pid_f405&mi_01&col02" });
			break;
		...
		case CXFILE_TYPE.Dongle:
			...
			bootEndPoints.Add(new string[2] { "vid_3554&pid_f405&mi_01&col01", "vid_3554&pid_f405&mi_01&col02" });
			normalEndPoints.Add(new string[2] { "vid_3554&pid_f512&mi_01&col05", "vid_3554&pid_f512&mi_01&col05" });
			break;
		}
	}
}
