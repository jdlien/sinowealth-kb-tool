...
public class DeviceFile_CH32V305PH : DeviceFile
{
	public DeviceFile_CH32V305PH(string _icName, string fileNameWithoutExtension, byte[] sourceFile)
	...
	public override void SetFileType(CXFILE_TYPE fileType)
	{
		...
		case CXFILE_TYPE.Mouse:
			...
			bootEndPoints.Add(new string[2] { "vid_3554&pid_f407&col01", "vid_3554&pid_f407&col01" });
