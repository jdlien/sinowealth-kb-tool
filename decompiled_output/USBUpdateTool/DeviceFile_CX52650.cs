...
public class DeviceFile_CX52650 : DeviceFile
{
	public DeviceFile_CX52650(string _icName, string fileNameWithoutExtension, byte[] sourceFile)
	...
	public override void SetFileType(CXFILE_TYPE fileType)
	{
		...
		case CXFILE_TYPE.Dongle:
			...
			bootEndPoints.Add(new string[2] { "vid_25a7&pid_fabc&mi_01&col01", "vid_25a7&pid_fabc&mi_01&col02" });
			normalEndPoints.Add(new string[2] { "vid_25a7&pid_fa7c&mi_01&col05", "vid_25a7&pid_fa7c&mi_01&col07" });
			break;
		}
	}
}
