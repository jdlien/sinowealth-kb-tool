...
public class DeviceFile_NRF52833_8K : DeviceFile
{
	public DeviceFile_NRF52833_8K(string _icName, string fileNameWithoutExtension, byte[] sourceFile)
	...
	{
		return new string[2] { "nrf52833_8k", "nrf52833-8k" };
	}
	...
	public override void SetFileType(CXFILE_TYPE fileType)
	{
		...
		case CXFILE_TYPE.Mouse:
			...
			bootEndPoints.Add(new string[2] { "vid_3554&pid_f40b&mi_01&col07", "vid_3554&pid_f40b&mi_01&col07" });
